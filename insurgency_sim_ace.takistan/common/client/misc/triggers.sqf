...
_trg = createTrigger ["EmptyDetector", position player]; 
_trg setTriggerText "Add Extra Actions"; 
_trg setTriggerActivation ["HOTEL", "PRESENT", true]; 
_trg setTriggerStatements ["this", 'player call addActionExtras;',""]; 

_trg = createTrigger ["EmptyDetector", position player]; 
_trg setTriggerText "Remove Extra Actions"; 
_trg setTriggerActivation ["INDIA", "PRESENT", true]; 
_trg setTriggerStatements ["this", 'player call addActionRemoveExtras;',""]; 
