...
//BIS_alice_mainscope setVariable ["townlist",[[],loc_1,loc_2,loc_3,loc_4,loc_5,loc_6,loc_7,loc_8,loc_9,loc_10,loc_11]];
...
BIS_alice_mainscope setVariable ["civilianCount","round (7 * (sqrt %1))"]; 
...
switch toLower(worldName) do {		
        ...
        case "takistan": {
                BIS_alice_mainscope setvariable ["trafficDistance",1100];
                BIS_alice_mainscope setvariable ["spawnDistance",750];
...
BIS_alice_mainscope setvariable ["threatDecay", 0.6, true];
